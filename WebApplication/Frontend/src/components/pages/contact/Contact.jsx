...
const Contact = () => {
    ...
    return (
        <main className="bg-[#0a1a2f] text-white font-sans min-h-screen flex items-center justify-center py-24 px-4">
            <div className="max-w-6xl w-full lg:grid lg:grid-cols-2 lg:gap-16 lg:items-start">

                {/* Contact Form */}
                <div>
                    <h2 className="text-3xl font-bold text-blue-300 sm:text-4xl mb-6">
                        Send Us a Message
                    </h2>
                    ...
                    <form
                        ref={form}
                        onSubmit={sendEmail}
                        className="space-y-6 bg-gradient-to-br from-[#102544] via-[#0d335c] to-[#0a457a] p-8 rounded-2xl shadow-xl border border-blue-900"
                    >
                        <div>
                            <label className="block text-blue-200 font-medium mb-2" htmlFor="name">
                                Full Name
                            </label>
                            <input
                                type="text"
                                ...
                                className="w-full px-4 py-3 rounded-lg bg-[#0f1e33] text-white border border-blue-700 focus:ring-2 focus:ring-blue-400 focus:border-transparent"
                                required
                            />
                        </div>

                        <div>
                            <label className="block text-blue-200 font-medium mb-2" htmlFor="email">
                                Email
                            </label>
                            <input
                                type="email"
                        ...
                        <div>
                            <label className="block text-blue-200 font-medium mb-2" htmlFor="message">
                                Message
                            </label>
                            <textarea
                                id="message"
                        ...
                        <button
                            type="submit"
                            className="bg-blue-600 text-white px-8 py-3 rounded-full font-semibold hover:bg-blue-500 transition-all transform hover:scale-105 shadow-lg"
                        >
                            Send Message
                        </button>
                    </form>
                ...
                <div className="mt-12 lg:mt-0">
                    ...
                    <div className="space-y-6">
                        <div className="flex items-start space-x-4">
                            ...
                            <p className="text-blue-100">deepakdesh565@gmail.com</p>
                        </div>
                        ...
                        <div className="flex items-start space-x-4">
                            ...
                            <p className="text-blue-100">+91 9508173611</p>
                        </div>
                        ...
                        <div className="flex items-start space-x-4">
                            ...
                            <p className="text-blue-100">Helpline: +91 98765 43210</p>
                        </div>
                        ...
                        <div className="flex items-start space-x-4">
                            ...
                            <p className="text-blue-100">Toll-Free: 1800-123-456</p>
                        </div>
